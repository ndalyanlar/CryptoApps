import 'package:crypto_dashboard/Pages/ForgetPassword.dart';
import 'package:crypto_dashboard/Pages/ProfilPage.dart';
import 'package:crypto_dashboard/Pages/SignUp.dart';
...
class AllPagesinOne extends StatefulWidget {
  AllPagesinOne();

  @override
  _AllPagesinOneState createState() => new _AllPagesinOneState();
}

class _AllPagesinOneState extends State<AllPagesinOne> {
